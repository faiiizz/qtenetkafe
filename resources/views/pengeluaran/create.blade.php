            ...
            <div class="card border-dark mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('pengeluaran') is-invalid @enderror" id="pengeluaran" name="pengeluaran" value="{{old('pengeluaran')}}">
                        @error('pengeluaran')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('rincian') is-invalid @enderror" id="rincian" name="rincian" value="{{old('rincian')}}">
                        @error('rincian')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
